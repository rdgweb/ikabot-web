    ...
    def get_context_data(self, **kwargs):
        ...
        for acct in accounts:
            ...
            for ga in game_accounts:
                ...
                account_cards.append({
                    ...
                    "free_freighters": _si(base.get("free_freighters")),
                    "max_freighters": _si(base.get("max_freighters")),
        ...
        for card in account_cards:
            account_detail_data.append({
                ...
                "free_freighters": card["free_freighters"],
                "max_freighters": card["max_freighters"],
