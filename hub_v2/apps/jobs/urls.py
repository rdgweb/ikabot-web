...
urlpatterns = [
    ...
    path("<uuid:pk>/edit/", JobEditFormView.as_view(), name="job-edit"),
    path("<uuid:pk>/plan-patch/", JobPlanQuickPatchView.as_view(), name="job-plan-patch"),
    path("<uuid:pk>/send-resources/", JobSendResourcesView.as_view(), name="job-send-resources"),
    # Job detail
