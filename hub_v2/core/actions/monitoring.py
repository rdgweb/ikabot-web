...
ACTIONS = {
    ...
    602: {
        ...
        "inputs": [
            {"key": "dump_mode", "type": FIELD_CHOICE, "label": "Escopo do dump", "required": True,
             "choices": [("own_islands", "Ilhas das minhas cidades"), ("region", "Regiao do mapa"), ("single_island", "Ilha especifica")],
             "default": "own_islands",
    ...
    702: {
        ...
        "long_running": True,
        "ready": True,
        "description": "Mantem a cidade lotada: com espaco na CM usa taverna maxima; lotada, baixa para o minimo seguro e gerencia os envios de vinho.",
        "inputs": [
            ...
            {"key": "growth_happiness_floor", "type": FIELD_INT, "label": "Margem de seguranca com a CM cheia", "required": True, "min": 0, "default": 2, "help": "Com espaco na CM, a taverna vai para o maximo. Quando a cidade lotar, este valor vira a felicidade total minima preservada para nao perder habitantes."},
