...
ACTIONS = {
    ...
    15: {
        ...
        "inputs": [
            ...
            {"key": "max_detection_risk", "type": FIELD_INT, "required": False, "default": 80,
             "min": 10, "max": 99, "label": "Sucesso mínimo alvo (%)",
             "help": "Calcula agentes para atingir esta probabilidade de sucesso. Mais agentes = mais sucesso mas mais risco."},
            {"key": "auto_agents", "type": FIELD_BOOL, "required": False, "default": True,
             "label": "Calcular agentes automaticamente pelo sucesso alvo"},
