...
ACTIONS = {
    ...
    18: {
        ...
        "long_running": False,
        "ready": True,
        "description": "Envia espiões para cidades inimigas para coletar informações.",
        "inputs": [
            ...
            {"key": "mission_id", "type": FIELD_CHOICE, "required": True, "default": "1", "label": "Missão",
             "choices": [
                 ("1", "Enviar espião"),
                 ("3", "Nível de pesquisa"),
            ...
            {"key": "max_detection_risk", "type": FIELD_INT, "required": False, "default": 25,
             ...
             "help": "Agentes são calculados automaticamente para ficar abaixo deste risco."},
