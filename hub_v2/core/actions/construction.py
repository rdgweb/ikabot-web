...
ACTIONS = {
    ...
    1301: {
        ...
        "long_running": False,
        "ready": True,
        "description": "Escolha uma cidade modelo e uma ou mais cidades alvo; gera um plano de construcao por alvo para igualar os edificios da modelo (opcionalmente ate um nivel maximo).",
        "inputs": [],
    },
    1302: {
        "name": "Reorganizar Edificios",
        "name_en": "Reorder buildings",
        "category": CAT_CONSTRUCTION,
        "icon": "bi-arrows-move",
        "runner": "reorder_buildings",
        "requires_game_session": True,
        "recurring": False,
        "long_running": False,
        "ready": True,
        "ui_hidden": True,
        "description": "Troca edificios de posicao na cidade (como o 'Reorganizar edificios' do jogo). Criado pelo painel de Construcoes: arrastar e soltar ou copiar o layout de outra cidade.",
        "inputs": [],
    },
    1004: {
        "name": "Construir Slot",
