...
BUILDING_CATALOG: dict[str, dict] = {
    ...
    "winpiegrower": {"name": "Vinhedos",            "name_en": "Wine Press",        "icon": "winepress.png", "bi": "bi-cup-fill"},
    "vineyard":     {"name": "Vinhedos",            "name_en": "Vineyard",          "icon": "winegrower.png", "bi": "bi-cup-fill"},
